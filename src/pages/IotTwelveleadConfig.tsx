...
const IotTwelveleadConfig: React.FC = () => {
  ...
  const tableData = [
    { id: 1, name: '十二导02', product: '十二导', type: '网关子设备', location: '-', status: '断开', remark: '-' },
    { id: 2, name: '十二导01', product: '十二导', type: '网关子设备', location: '-', status: '断开', remark: '-' },
  ];
...
export default IotTwelveleadConfig;