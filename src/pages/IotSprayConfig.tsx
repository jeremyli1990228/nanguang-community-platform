...
const IotSprayConfig: React.FC = () => {
  ...
  const tableData = [
    { id: 1, name: '喷淋装置001', product: '喷淋系统-海湾', type: '消防设备', grid: '-', location: '南光村1栋', status: '在线', remark: '-' },
    { id: 2, name: '喷淋装置002', product: '喷淋系统-海湾', type: '消防设备', grid: '-', location: '南光村2栋', status: '在线', remark: '-' },
    { id: 3, name: '喷淋装置003', product: '喷淋系统-海湾', type: '消防设备', grid: '-', location: '南光村3栋', status: '断开', remark: '维护中' },
  ];
