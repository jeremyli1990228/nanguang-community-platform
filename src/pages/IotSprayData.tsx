...
const IotSprayData: React.FC = () => {
  ...
  const tableData = [
    { id: 1, name: '喷淋装置001', location: '南光村1栋', dataType: '水压', data: '0.4MPa', time: '2026-05-20 15:12:36' },
    { id: 2, name: '喷淋装置001', location: '南光村1栋', dataType: '阀门状态', data: '关闭', time: '2026-05-20 15:12:36' },
    { id: 3, name: '喷淋装置001', location: '南光村1栋', dataType: '温度', data: '25℃', time: '2026-05-20 15:12:36' },
    { id: 4, name: '喷淋装置002', location: '南光村2栋', dataType: '水压', data: '0.38MPa', time: '2026-05-20 15:11:20' },
    { id: 5, name: '喷淋装置002', location: '南光村2栋', dataType: '阀门状态', data: '关闭', time: '2026-05-20 15:11:20' },
    { id: 6, name: '喷淋装置002', location: '南光村2栋', dataType: '温度', data: '24℃', time: '2026-05-20 15:11:20' },
  ];
