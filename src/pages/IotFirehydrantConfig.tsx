...
const IotFirehydrantConfig: React.FC = () => {
  ...
  const tableData = [
    { id: 1, name: '鸿瑞花园26栋', product: '消防栓传感器', type: '网猴子设备', grid: '李宪政', building: '南光路65号鸿瑞花园2…', location: '鸿瑞花园26栋', status: '断开', remark: '消防栓' },
    { id: 2, name: '鸿瑞花园27栋', product: '消防栓传感器', type: '网猴子设备', grid: '陈俊杰', building: '鸿瑞花园27栋', location: '鸿瑞花园27栋', status: '断开', remark: '消防栓' },
    { id: 3, name: '鸿瑞花园13栋', product: '消防栓传感器', type: '网猴子设备', grid: '陈俊杰', building: '鸿瑞花园13-14-15栋', location: '鸿瑞花园13栋', status: '断开', remark: '消防栓' },
    { id: 4, name: '鸿瑞花园14栋', product: '消防栓传感器', type: '网猴子设备', grid: '陈俊杰', building: '鸿瑞花园13-14-15栋', location: '鸿瑞花园14栋', status: '断开', remark: '消防栓' },
    { id: 5, name: '鸿瑞花园15栋', product: '消防栓传感器', type: '网猴子设备', grid: '陈俊杰', building: '鸿瑞花园13-14-15栋', location: '鸿瑞花园15栋', status: '断开', remark: '消防栓' },
    { id: 6, name: '鸿瑞花园16栋', product: '消防栓传感器', type: '网猴子设备', grid: '黄艳芳', building: '鸿瑞花园16、17、18…', location: '鸿瑞花园16栋', status: '断开', remark: '消防栓' },
    { id: 7, name: '鸿瑞花园17栋', product: '消防栓传感器', type: '网猴子设备', grid: '黄艳芳', building: '鸿瑞花园16、17、18…', location: '鸿瑞花园17栋', status: '断开', remark: '消防栓' },
    { id: 8, name: '鸿瑞花园18栋', product: '消防栓传感器', type: '网猴子设备', grid: '黄艳芳', building: '鸿瑞花园16、17、18…', location: '鸿瑞花园18栋', status: '断开', remark: '消防栓' },
    { id: 9, name: '鸿瑞花园19栋', product: '消防栓传感器', type: '网猴子设备', grid: '黄艳芳', building: '鸿瑞花园16、17、18…', location: '鸿瑞花园19栋', status: '断开', remark: '消防栓' },
    { id: 10, name: '鸿瑞花园20栋', product: '消防栓传感器', type: '网猴子设备', grid: '李宪政', building: '南光路65号鸿瑞花园2…', location: '鸿瑞花园20栋', status: '断开', remark: '消防栓' },
    { id: 11, name: '鸿瑞花园21栋', product: '消防栓传感器', type: '网猴子设备', grid: '李宪政', building: '南光路65号鸿瑞花园2…', location: '鸿瑞花园21栋', status: '断开', remark: '消防栓' },
    { id: 12, name: '鸿瑞花园22栋', product: '消防栓传感器', type: '网猴子设备', grid: '李宪政', building: '南光路65号鸿瑞花园2…', location: '鸿瑞花园22栋', status: '断开', remark: '消防栓' },
    { id: 13, name: '鸿瑞花园23栋', product: '消防栓传感器', type: '网猴子设备', grid: '李宪政', building: '南光路65号鸿瑞花园2…', location: '鸿瑞花园23栋', status: '断开', remark: '消防栓' },
    { id: 14, name: '鸿瑞花园24栋', product: '消防栓传感器', type: '网猴子设备', grid: '李宪政', building: '鸿瑞花园24栋', location: '鸿瑞花园24栋', status: '断开', remark: '消防栓' },
    { id: 15, name: '鸿瑞花园25栋', product: '消防栓传感器', type: '网猴子设备', grid: '李宪政', building: '南光路65号鸿瑞花园2…', location: '鸿瑞花园25栋', status: '断开', remark: '消防栓' },
  ];
...
export default IotFirehydrantConfig;
