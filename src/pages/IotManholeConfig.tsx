...
const IotManholeConfig: React.FC = () => {
  ...
  const tableData = [
    { id: 1, name: '智能井盖检测终端685', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '-', status: '在线', remark: '-' },
    { id: 2, name: '智能井盖检测终端688', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '-', status: '在线', remark: '-' },
    { id: 3, name: '智能井盖检测终端684', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '-', status: '在线', remark: '-' },
    { id: 4, name: '智能井盖检测终端686', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '-', status: '断开', remark: '-' },
    { id: 5, name: '智能井盖检测终端689', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '-', status: '在线', remark: '智能井盖检测终端689' },
    { id: 6, name: '智能井盖检测终端683', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '-', status: '在线', remark: '-' },
    { id: 7, name: '智能井盖检测终端687', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '-', status: '在线', remark: '-' },
    { id: 8, name: '智能井盖检测终端19', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '兰州拉面门前约10米', status: '断开', remark: '污水井' },
    { id: 9, name: '智能井盖检测终端1', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '文鑫诊所门口左侧', status: '在线', remark: '雨水井' },
    { id: 10, name: '智能井盖检测终端5', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '文鑫诊所门前马路中', status: '在线', remark: '污水井' },
    { id: 11, name: '智能井盖检测终端570', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '南光村4栋3单元丁路口中间', status: '在线', remark: 'null' },
    { id: 12, name: '智能井盖检测终端569', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '南光村4栋1单元二单元中...', status: '在线', remark: 'null' },
    { id: 13, name: '智能井盖检测终端568', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '南光村5东旁多功能杆下，...', status: '在线', remark: 'null' },
    { id: 14, name: '智能井盖检测终端566', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '南光村村堂左、丁路口中间', status: '在线', remark: 'null' },
    { id: 15, name: '智能井盖检测终端567', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '南光村45号墙角', status: '在线', remark: 'null' },
    { id: 16, name: '智能井盖检测终端563', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '南光村6栋二单元右', status: '断开', remark: 'null' },
    { id: 17, name: '智能井盖检测终端561', product: '智能井盖-湖南菲尔斯', type: '网关子设备', grid: '-', location: '4栋二单元右一草地', status: '在线', remark: 'null' },
  ];
...
export default IotManholeConfig;