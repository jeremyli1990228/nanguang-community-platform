...
const IotWatchConfig: React.FC = () => {
  ...
  const tableData = [
    { id: 1, name: '863225051128485', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 2, name: '863225051125051', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 3, name: '863225051126315', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 4, name: '863225051128642', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 5, name: '863225051125143', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 6, name: '863225051127966', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 7, name: '863225051124781', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 8, name: '863225051125010', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 9, name: '863225051125721', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 10, name: '863225051128386', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 11, name: '863225051126471', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 12, name: '863225051125184', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 13, name: '863225051127875', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 14, name: '863225051125796', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 15, name: '863225051128790', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 16, name: '863225051127024', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 17, name: '863225051127156', product: '智能手环-爱牵挂', type: '网猴子设备', grid: '-', building: '-', location: '-', status: '断开', remark: '-' },
  ];
