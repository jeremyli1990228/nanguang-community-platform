...
const IotHealthConfig: React.FC = () => {
  ...
  const tableData = [
    { id: 1, name: '健康一体机03', product: '健康一体机-双佳医疗', type: '网猴子设备', grid: '-', building: '-', location: '03号', status: '断开', remark: '-' },
    { id: 2, name: '健康一体机02', product: '健康一体机-双佳医疗', type: '网猴子设备', grid: '-', building: '-', location: '02号', status: '断开', remark: '-' },
    { id: 3, name: '健康一体机01', product: '健康一体机-双佳医疗', type: '网猴子设备', grid: '-', building: '-', location: '01号', status: '断开', remark: '-' },
  ];
...
export default IotHealthConfig;
