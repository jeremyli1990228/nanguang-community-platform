...
const IotRecorderConfig: React.FC = () => {
  ...
  const tableData = [
    { id: 1, name: '4G执法仪2460299-宋晓红15811...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 2, name: '4G执法仪2460310-唐韵清18820...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 3, name: '4G执法仪2460308-赵俊豪13590...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 4, name: '4G执法仪2460309-吴颖曼13925...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 5, name: '4G执法仪2460311-阮海燕13641...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 6, name: '4G执法仪2745515-陈晓慧13929...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 7, name: '4G执法仪2460306-李天龙13534...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 8, name: '4G执法仪2460307-王稳1882096...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 9, name: '4G执法仪2460305-王文庆13534...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 10, name: '4G执法仪2460304-刘信然18820...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 11, name: '4G执法仪2460303-陈玉虹13534...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 12, name: '4G执法仪2460302-古思琪13925...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 13, name: '4G执法仪2460301-钟婉婷13534...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 14, name: '4G执法仪2460300-李明骏13534...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 15, name: '4G执法仪8078461-朱梦意18820...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 16, name: '4G执法仪2460294-沈子威13925...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
    { id: 17, name: '4G执法仪2460293-胡天送13534...', product: '海康4G执法仪', building: '-', location: '-', status: '断开', remark: '-' },
  ];
...
export default IotRecorderConfig;
